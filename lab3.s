...
;global variables go here
       ...
       THUMB
       EXPORT EID1
EID1   DCB "20210702",0  ;replace ABC123 with your EID
       EXPORT EID2
EID2   DCB "20210702",0  ;replace ABC123 with your EID
       ALIGN 4
...
; TExaS_Init sets bus clock at 80 MHz, interrupts, ADC1, TIMER3, TIMER5, and UART0
 ...
 ; Your Initialization goes here
	...
	; Configure PE4 as output, PE0 and PE2 as input
	LDR R0,=GPIO_PORTE_DIR_R
	LDR R1,[R0]
	ORR R1,R1,#0x10
	STR R1,[R0]
	
	; Configure PE4, PE2, PE0 pins
	...
	;Configure constant
	MOV32 R4,#1000000 ; 20% of a cycle
	MOV32 R5,#500000 ; 50ms
	MOV32 R6,#4500000 ; 450ms
	MOV R7,#1 ; Count On cycle state
	MOV R8,#0
	LDR R9,=SinTable ; Perlin Table for Breath
...
; main engine goes here
	 ...
	 LDR R1,[R0] 
	 ; R2 stores the bit value of Change button
	 AND R2,R1,#0x01
	 ; R3 stores the bit value of Breath button
	 AND R3,R1,#0x04
	 LSR R3,R3,#2
...
Change
	...
	LDR R0, = GPIO_PORTE_DATA_R
	LDR R1, [R0]
	AND R2, R1, #0x01 ;save change switch to R2
...
DelayOn ; Deley On for 100ns*R10
	NOP ;dummy operation
	NOP
	NOP
	NOP
	...
	BNE DelayOn
	BX LR	
DelayOff ; Deley Off for 100ns*R10
	NOP ;dummy operation
	NOP
	NOP
	NOP
